...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Package.is_protected'
        db.delete_column('pyppi_package', 'is_protected')

        # Deleting field 'Package.is_public'
        db.delete_column('pyppi_package', 'is_public')

        # Adding field 'Package.visibility'
        db.add_column('pyppi_package', 'visibility',
                      self.gf('django.db.models.fields.IntegerField')(default=3),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Package.is_protected'
        db.add_column('pyppi_package', 'is_protected',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Package.is_public'
        db.add_column('pyppi_package', 'is_public',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Package.visibility'
        db.delete_column('pyppi_package', 'visibility')
