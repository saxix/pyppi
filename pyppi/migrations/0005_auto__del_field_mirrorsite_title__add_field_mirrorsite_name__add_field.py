...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MirrorSite.title'
        db.delete_column('pyppi_mirrorsite', 'title')

        # Adding field 'MirrorSite.name'
        db.add_column('pyppi_mirrorsite', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'MirrorSite.enabled'
        db.add_column('pyppi_mirrorsite', 'enabled',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'MirrorSite.title'
        raise RuntimeError("Cannot reverse this migration. 'MirrorSite.title' and its values cannot be restored.")
        # Deleting field 'MirrorSite.name'
        db.delete_column('pyppi_mirrorsite', 'name')

        # Deleting field 'MirrorSite.enabled'
        db.delete_column('pyppi_mirrorsite', 'enabled')
