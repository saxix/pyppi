...
extlinks = {'issue': ('http://pcc.wfp.org/redmine/issues/', 'issue ')}

todo_include_todos = True
intersphinx_mapping = {
   'python': ('http://python.readthedocs.org/en/latest/', None),
   'django': ('https://docs.djangoproject.com/en/1.4/', None),
   # 'django': ('https://docs.djangoproject.com/en/1.4/', 'http://docs.djangoproject.com/en/dev/_objects/'),
...
latex_documents = [
    ('index', 'wfp.tex', u"WFP Documentation",
...
man_pages = [
    ('index', 'wfpdoc', u"WFP Documentation",
